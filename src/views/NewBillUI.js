            ...
            <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="col-half">
                    ...
                    <span data-testid="fileErrorMsg" id="fileErrorMsg"> </span>
                  </div>
                </div>
            </div>
            <div class="row">
              <div class="col-md-6">
                <div class="col-half">
                  <button type="submit" id='btn-send-bill' data-testid='btn-send-newbill' class="btn btn-primary">Envoyer</button>
                </div>
              </div>
            </div>
          </form>
